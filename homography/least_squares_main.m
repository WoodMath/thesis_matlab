function main = least_squares_main()
    ...
    [x_lin, norm_l, x_q, norm_q] = least_squares_student(t1, ft1);
    fprintf('data 1\n')
    fprintf('linear:\n')
    fprintf('f(t) = %f + %f t\n', x_lin(1), x_lin(2));
    fprintf('||b - Ax|| = %f\n\n', norm_l );
    ...
    [x_lin, norm_l, x_q, norm_q] = least_squares_student(t2, ft2);
    fprintf('data 2\n')
    fprintf('linear:\n')
    fprintf('f(t) = %f + %f t\n', x_lin(1), x_lin(2));
    fprintf('||b - Ax|| = %f\n\n', norm_l );
