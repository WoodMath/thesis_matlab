function [v_source, v_dest] = fnMovePoint(fig_source, fig_dest)
...
%     end
    ...
    h_point = plot(v_source(1,2), v_source(1,1), 'sb', 'MarkerSize', 5, 'MarkerEdgeColor', 'b', 'MarkerFaceColor', 'b');
    hold off

    sfigure(fig_dest);
    hold on
    %% Draw a red dot on destination
    h_point = plot(v_dest(1,2), v_dest(1,1), 'sr', 'MarkerSize', 5, 'MarkerEdgeColor', 'r', 'MarkerFaceColor', 'r');
    hold off
